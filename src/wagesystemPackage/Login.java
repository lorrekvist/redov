                ...
                case 1:
                    ...
                    do {
                        ...
                        switch (menuInt) {
                            ...
                            case 9:
                                System.out.println("Push admin wages forward");
                                admin.pushWages(adminBankAccounts, adminWageList);
                        }
                    } while (menuInt != 0);
                    break;
                case 2:
                    ...
                    do {
                        System.out.println("Welcome, please choose: 1 for bank account, 2 for wage, 3 for role, 4 for role change request, 5 for raise change request, 6 to delete your account, 7 to quit. ");
                        try {
                            menuInt = Integer.parseInt(scan.next());
                        } catch (NumberFormatException e) {
                            System.out.println("Invalid choice. You can only chose either 1 for Admin or 2 for Regular, 3 to Quit.: ");
